...
def scrape():
    ...
    featured_image_list.append(image)
    feature_image = featured_image_list[0]
    temp_list = str(feature_image).split('"')
    mars_collection["featured_image_url"] = "https://jpl.nasa.gov" + temp_list[7]
    ...
    mars_collection["mars_facts_table"] = mars_html_table
